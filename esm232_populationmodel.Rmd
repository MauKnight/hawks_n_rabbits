...
ini = 10
nmonths = 24
fert_rabbit2 = c(F1,F2,F3)
surv_rabbit2 = c(p12,p23,p34)
rabbit_pop2=evolve_pop(fert_rabbit2, surv_rabbit2, ini, nmonths)

# population after 24 months
rabbit_pop2$poptot[24]
```
