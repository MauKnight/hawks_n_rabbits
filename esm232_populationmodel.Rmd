...
ggplot(rabbit_tot, aes(decade, poptot))+
  geom_col()+
  labs(title="Total population per decade",
       y="Total Population",
       x="Decade")
...
rabbit_agesl = rabbit_ages %>% 
  gather(key="agecat", value="pop",-decade)

# plot information about ages
ggplot(rabbit_agesl, aes(decade, pop, fill=agecat))+
  geom_col()+
...
sens_micro=tell(sens_rabbit, res)
